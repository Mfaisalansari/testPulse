...
[![CI](https://github.com/Mfaisalansari/testPulse/actions/workflows/ci.yml/badge.svg)](https://github.com/Mfaisalansari/testPulse/actions/workflows/ci.yml)
...
| `testpulse-cucumber3`   | ✅ Built  | Cucumber 3 hooks + AspectJ step interception     |
| `testpulse-testng`      | ✅ Built  | ISuiteListener + BaseRunner for multi-LOB suites  |
| `testpulse-junit4`      | ✅ Built  | `@ClassRule` for sequential runners               |
| `testpulse-bom`         | ✅ Built  | Version coordination for consumers                |

## Installing

Recommended — import the BOM once, then add the modules you need without
managing their versions individually:
...
<dependencies>
    <!-- Pick the integrations your stack needs — versions come from the BOM -->
    <dependency>
        <groupId>com.testpulse</groupId>
...
`testpulse-core` is pulled transitively — you don't add it explicitly.
...
For a single module or non-Maven build systems, depend on the artifact directly:
